...
def consolidate_tweets():
    main_file = "C:/Data_collection/tweets.csv"
    tweet_files = ["C:/Data_collection/S1/tweets.csv" ,
                   "C:/Data_collection/S2/tweets.csv",
                   "C:/Data_collection/S3/tweets.csv" ]
    ...
    file_paths = ["C:/Data_collection/S1/usernames.csv" ,
                   "C:/Data_collection/S2/usernames.csv",
                   "C:/Data_collection/S3/usernames.csv" ]
...
def main():
   ...
   # Store data, divide usernames.
    ...
    work_done = "DONE...., In = " + str(elapsed_time) + " seconds."
